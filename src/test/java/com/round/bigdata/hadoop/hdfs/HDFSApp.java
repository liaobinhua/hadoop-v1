...
public class HDFSApp {
  ...
  public void create() throws Exception {
    FSDataOutputStream out = fileSystem.create(new Path("/hadoop/test2/c.txt"));
  ...
  public void copyFromLocalBigFile() throws Exception {
    InputStream in = new BufferedInputStream(new FileInputStream(
        new File("/Users/binhualiao/Project/BigData/coding301-master/coding301/hadoop-train-v2/ip/qqwry.dat")));
    FSDataOutputStream out = fileSystem.create(new Path("/hadoop/test2/ip.dat"),
        new Progressable() {
